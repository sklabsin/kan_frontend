...
export default function ManageSector()
{
    ...
    const [field,setField]=useState([{fieldName:"Sl No",fieldData:"id"},{fieldName:"State",fieldData:"state"},{fieldName:"District",fieldData:"district"},{fieldName:"Sector",fieldData:"sector"},{fieldName:"Action",fieldData:""}])
    let initialValue={
        state:null,
        district:null,
        localbodytype:null,
