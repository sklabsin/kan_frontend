...
import ListPanchayat  from './List/ListPanchayat';
...
export default function ManagePanchayat()
{
    ...
    const [field,setField]=useState([{fieldName:"Sl No",fieldData:"id"},{fieldName:"State",fieldData:"state"},{fieldName:"District",fieldData:"district"},{fieldName:"Panchayat",fieldData:"panchayat"},{fieldName:"Action",fieldData:""}])
    let initialValue={
        state:null,
        district:null,
        panchayat:""
              ...
              <Row>
                        <Col md="3">
                            ...
                            <Field
                                ...
                                as={Input}
                                invalid={errors.panchayat && touched.panchayat}
                                autoComplete="off"
                              />
                            </FormGroup>
                            </Col>
