...
import ListCorporation  from './List/ListCorporation';
import RSelect from '../../../components/RSelect/RSelect';
import RSelectMulti from '../../../components/RSelectMulti/RSelectMulti';
export default function ManageCorporation()
{
    ...
    const [field,setField]=useState([{fieldName:"Sl No",fieldData:"id"},{fieldName:"State",fieldData:"state"},{fieldName:"District",fieldData:"district"},{fieldName:"Corporation",fieldData:"corporation"},{fieldName:"Action",fieldData:""}])
    let initialValue={
        state:null,
        district:null,
        corporation:""
              ...
              <Row>
                        <Col md="3">
                            ...
                            <Field
                                ...
                                as={Input}
                                invalid={errors.corporation && touched.corporation}
                                autoComplete="off"
                              />
                            </FormGroup>
                            </Col>
