...
export default function ManageRole()
{
    ...
    const [data,setData]=useState([{id:1,role:"Role 1"}]);
    const [field,setField]=useState([{fieldName:"Sl No",fieldData:"id"},{fieldName:"Role",fieldData:"role"},{fieldName:"Action",fieldData:"id"}])
    let initialValue={
        role:"",
       }
